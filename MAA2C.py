...
class MAA2C(Agent):
    ...
    def interact(self):
        ...
        for i in range(self.roll_out_n_steps):
            ...
            next_state, reward, done, _ = self.env.step([index_to_one_hot(a, self.action_dim) for a in action])
            self.n_steps += 1
            print(self.n_steps)
            done = done[0]
    ...
    def train(self):
        ...
        for agent_id in range(self.n_agents):
            ...
            target_values = rewards_var[:,agent_id,:].detach()
    ...
    def eval_action(self, state):
        ...
        for agent_id in range(self.n_agents): 
            ...
            one_hot_actions.append(index_to_one_hot(actions[agent_id],self.action_dim))
